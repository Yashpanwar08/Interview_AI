...
const Interview = () => {
    ...
    const { report, getReportById, loading, getResumePdf, downloadingResumeId } = useInterview()
    ...
    const isDownloading = downloadingResumeId === interviewId
                ...
                <div className='interview-layout'>
                    ...
                    <aside className='interview-sidebar'>
                        ...
                        <div className='match-score'>
                            ...
                            <p className='match-score__sub'>Match rating for this role</p>
                        </div>
